#include"PlayerEffectHit1Factory.h"
...
* @desc コンストラクタ
*/
CPlayerEffectHit1Factory::CPlayerEffectHit1Factory()
{
...
* @param 初期座標Y
*/
void CPlayerEffectHit1Factory::settingMove(CCharacter* pCharacter, float posX, float posY)
{
	//移動データの取得
...
* @param 敵キャラクターインスタンスのアドレス
*/
void CPlayerEffectHit1Factory::settingTexture(CCharacter* pCharacter)
{
	//テクスチャの設定
...
* @param 敵キャラクターインスタンスのアドレス
*/
void CPlayerEffectHit1Factory::settingAnimations(CCharacter* pCharacter)
{
...
* @param 敵キャラクターインスタンスのアドレス
*/
void CPlayerEffectHit1Factory::settingPhysicals(CCharacter* pCharacter)
{
	/*
	//物理演算データ群の取得
...
* @param 敵キャラクターインスタンスのアドレス
*/
void CPlayerEffectHit1Factory::settingActions(CCharacter* pCharacter)
{
	/*
	//アクションデータ群の取得
...
* @param 敵キャラクターインスタンスのアドレス
*/
void CPlayerEffectHit1Factory::settingBody(CCharacter* pCharacter)
{
	//実体データの取得
...
* @param 衝突判定領域データ群
*/
void CPlayerEffectHit1Factory::settingCollisionAreas(CCharacter* pCharacter)
{
	//========================================
	// 衝突判定空間の生成
	//========================================
...
* @param 敵キャラクターインスタンスのアドレス
*/
void CPlayerEffectHit1Factory::settingStateMachine(CCharacter* pCharacter)
{
	/*
	//待機状態
	pCharacter->m_stateMachine->registerState((int)CPlayerEffectHit1Enemy::STATE::IDLE, new CPlayerEffectHit1StateIdle((CPlayerEffectHit1Enemy*)pCharacter));
	...
	//初期状態の設定
	pCharacter->m_stateMachine->setStartState((int)CPlayerEffectHit1Enemy::STATE::IDLE);
...
* @param 敵キャラクターインスタンスのアドレス
*/
void CPlayerEffectHit1Factory::settingInitialize(CCharacter* pCharacter)
{
	//状態の設定
